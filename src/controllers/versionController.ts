...
const APK_URL =
    'https://github.com/aryansingh1013/Fixmate/releases/download/v1.0.2/fixmate.apk';
...
export const getVersion = (_req: Request, res: Response) => {
    return sendSuccess(res, 'Version info', {
        ...
        releaseNotes: 'Booking system fixed: accept/decline now works, complaints screen added for providers.',
    });
};
